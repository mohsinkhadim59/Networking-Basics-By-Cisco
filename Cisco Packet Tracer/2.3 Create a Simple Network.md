...
- [Part 1: Build a Simple Network](#part-1-build-a-simple-network)
  - [Step 1: Add network devices to the workspace.](#step-1-add-network-devices-to-the-workspace)
  - [Step 2: Change display names of the network devices.](#step-2-change-display-names-of-the-network-devices)
  - [Step 3: Add the physical cabling between devices on the workspace.](#step-3-add-the-physical-cabling-between-devices-on-the-workspace)
- [Part 2: Configure the End Devices and Verify Connectivity](#part-2-configure-the-end-devices-and-verify-connectivity)
  - [Step 1: Configure the PC.](#step-1-configure-the-pc)
  - [Step 2: Configure the Laptop.](#step-2-configure-the-laptop)
...
-  **Internet Cloud:** Network Devices > WAN Emulation > Internet Cloud
- **Wireless Router**: Network Devices > Wireless Devices > Wireless Router
...
![Simple Network](/Images/cisco.png)
<p align="center"><em>Figure 0: Building a Simple Network and accessing via Laptop</em></p>

![Ping](/Images/ping.png)
<p align="center"><em>Figure 1: Pinging `cisco.srv` from the PC</em></p>

>The **.pka** file is available in the repo in case to get assistance in creating a simple network but first try making it out on your own.
