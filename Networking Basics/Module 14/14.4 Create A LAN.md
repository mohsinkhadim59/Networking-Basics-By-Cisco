...
- [Packet Tracer - Observe Traffic Flow in a Routed Network](#packet-tracer---observe-traffic-flow-in-a-routed-network)
  ...
  - [Part 3: Observe Traffic Flow in the Routed Network.](#part-3-observe-traffic-flow-in-the-routed-network)
    ...
    - [Step 2: Ping other hosts.](#step-2-ping-other-hosts)
      - [Question:](#question-2)
- [Packet Tracer - Create a LAN](#packet-tracer---create-a-lan)
  - [Addressing Table](#addressing-table)
  - [Objectives](#objectives-1)
  - [Background / Scenario](#background--scenario-1)
  - [Instructions](#instructions-1)
  - [Part 1: Connect Network Devices and Hosts](#part-1-connect-network-devices-and-hosts)
    - [Step 1: Power on the end devices and Office Router.](#step-1-power-on-the-end-devices-and-office-router)
    - [Step 2: Connect the end devices.](#step-2-connect-the-end-devices)
  - [Part 2: Configure Devices with IPv4 Addressing](#part-2-configure-devices-with-ipv4-addressing)
    - [Step 1: Configure the hosts with addressing information.](#step-1-configure-the-hosts-with-addressing-information)
      - [Question 1:](#question-1)
      - [Question 2:](#question-2)
  - [Part 3: Verify the End Device Configuration and Connectivity](#part-3-verify-the-end-device-configuration-and-connectivity)
    - [Step 1: Verify connectivity between the two PCs.](#step-1-verify-connectivity-between-the-two-pcs)
    - [Step 2: Verify connectivity to the internet.](#step-2-verify-connectivity-to-the-internet)
      - [Question 3:](#question-3)
  - [Part 4: Use Networking Commands to View Host Information](#part-4-use-networking-commands-to-view-host-information)
    - [Step 1: Use the ipconfig command.](#step-1-use-the-ipconfig-command)
      - [Question 4:](#question-4)
    - [Step 2: Use the tracert command.](#step-2-use-the-tracert-command)
...
<p align="center"><em>Figure 2: All Hosts in One Local Segment</em></p>
...
<p align="center"><em>Figure 3: Hosts on Remote Segments</em></p>
...
> **Note**: There is no power switch on the switch model used in this activity.
...
There is another activity that is also present inside this folder and once you open this activity in the Cisco Packet Tracer you will get all the instructions related to that:
![[Observe Traffic Flow in a Routed Network.pka]]